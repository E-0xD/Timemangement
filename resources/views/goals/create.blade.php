<x-layouts::app>
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-4 md:p-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-xl font-semibold text-zinc-900 dark:text-zinc-100">New Goal</h1>
                <p class="mt-0.5 text-sm text-zinc-500 dark:text-zinc-400">Set a target to work towards</p>
            </div>
        </div>
        ...
        <div class="mx-auto w-full max-w-2xl">
            <div class="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                <form method="POST" action="{{ route('goals.store') }}">
                    ...
                    @include('goals.partials.form-fields')
